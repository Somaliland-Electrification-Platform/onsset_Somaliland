...
def read_wind_environmental_data():
    ...
    wind_curve = pd.read_csv('..\onsset_Somaliland\Supplementary_files\Somaliland_Wind.csv', usecols=[3], skiprows=3).values
    #wind_curve = pd.read_csv('..\Supplementary_files\Somaliland_Wind.csv', usecols=[3], skiprows=3).values
    return wind_curve
